sap.ui.define(
	...
	function(UIComponent){
		return UIComponent.extend("com.nikitatrainings.Component",{
			metadata: {
				manifest: "json"
			},
			init: function(){
			...
			// 		viewName: "com.nikitatrainings.view.App",
			// 		type: "XML"
			// 	});
			...
			// 		viewName: "com.nikitatrainings.view.View1",
			// 		type: "XML"
			// 	});
			
			// 	var oView2 = new sap.ui.view("idView2",{
			// 		viewName: "com.nikitatrainings.view.View2",
			// 		type: "XML"
			// 	});
			// 	var oEmpty = new sap.ui.view("idEmpty",{
			// 		viewName: "com.nikitatrainings.view.Empty",
			// 		type: "XML"
			// 	});
